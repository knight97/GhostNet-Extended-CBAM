...
class GhostModule(nn.Module):
    def __init__(self, inp, oup, kernel_size=1, ratio=15, dw_size=3, stride=1, relu=True):
...
class GhostNet_N15(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=1.0, dropout=0.2):

        super(GhostNet_N15, self).__init__()
...
def ghostnetN15(**kwargs):
    ...
    return GhostNet_N15(cfgs, **kwargs)
